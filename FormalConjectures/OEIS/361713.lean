...
/-!
# Sum of products $\binom{n}{k}^2 \binom{n+k-1}{k}^2$
...
/--
The sequence $a(n) = \sum_{k=0}^{n-1} \binom{n}{k}^2 \binom{n+k-1}{k}^2$.
-/
def a (n : ℕ) : ℕ :=
  ∑ k ∈ range n, (n.choose k) ^ 2 * ((n + k - 1).choose k) ^ 2
