...
lemma max_2_3_5_7_13 : (Finset.max ({2, 3, 5, 7, 13} : Finset ℕ)) = some 13 := by
  rw [Finset.max_insert, Finset.max_insert, Finset.max_insert, Finset.max_insert, Finset.max_singleton]
  rfl

@[category API, AMS 11]
lemma prop_1 : largest_prime_divisor_property 1 = 3 := by
  unfold largest_prime_divisor_property
  have h_set : (Finset.filter Nat.Prime (Finset.image (fun d => d + 1) (2 * 1).divisors)) = {2, 3} := by
    classical
    ext x
    simp only [Finset.mem_filter, Finset.mem_image, Nat.mem_divisors, Finset.mem_insert, Finset.mem_singleton]
    constructor
    · rintro ⟨⟨d, hd1, rfl⟩, hp⟩
  ...
  change (Option.getD (Finset.filter Nat.Prime (Finset.image (fun d => d + 1) (2 * 1).divisors)).max 0) = 3
  rw [h_set, max_2_3]
  rfl
...
lemma prop_2 : largest_prime_divisor_property 2 = 5 := by
  unfold largest_prime_divisor_property
  have h_set : (Finset.filter Nat.Prime (Finset.image (fun d => d + 1) (2 * 2).divisors)) = {2, 3, 5} := by
    classical
    ext x
    simp only [Finset.mem_filter, Finset.mem_image, Nat.mem_divisors, Finset.mem_insert, Finset.mem_singleton]
    constructor
  ...
  change (Option.getD (Finset.filter Nat.Prime (Finset.image (fun d => d + 1) (2 * 2).divisors)).max 0) = 5
  rw [h_set, max_2_3_5]
  rfl
...
lemma prop_3 : largest_prime_divisor_property 3 = 7 := by
  unfold largest_prime_divisor_property
  have h_set : (Finset.filter Nat.Prime (Finset.image (fun d => d + 1) (2 * 3).divisors)) = {2, 3, 7} := by
    classical
    ext x
    simp only [Finset.mem_filter, Finset.mem_image, Nat.mem_divisors, Finset.mem_insert, Finset.mem_singleton]
    constructor
  ...
  change (Option.getD (Finset.filter Nat.Prime (Finset.image (fun d => d + 1) (2 * 3).divisors)).max 0) = 7
  rw [h_set, max_2_3_7]
  rfl
...
lemma prop_4 : largest_prime_divisor_property 4 = 5 := by
  unfold largest_prime_divisor_property
  have h_set : (Finset.filter Nat.Prime (Finset.image (fun d => d + 1) (2 * 4).divisors)) = {2, 3, 5} := by
    classical
    ext x
    simp only [Finset.mem_filter, Finset.mem_image, Nat.mem_divisors, Finset.mem_insert, Finset.mem_singleton]
    constructor
    ...
    · rintro (rfl | rfl | rfl)
      ...
      · refine ⟨⟨2, ⟨by decide, by decide⟩, rfl⟩, Nat.prime_three⟩
      · refine ⟨⟨4, ⟨by decide, by decide⟩, rfl⟩, Nat.prime_five⟩
  change (Option.getD (Finset.filter Nat.Prime (Finset.image (fun d => d + 1) (2 * 4).divisors)).max 0) = 5
  rw [h_set, max_2_3_5]
  rfl
...
lemma prop_6 : largest_prime_divisor_property 6 = 13 := by
  unfold largest_prime_divisor_property
  have h_set : (Finset.filter Nat.Prime (Finset.image (fun d => d + 1) (2 * 6).divisors)) = {2, 3, 5, 7, 13} := by
    classical
    ext x
    simp only [Finset.mem_filter, Finset.mem_image, Nat.mem_divisors, Finset.mem_insert, Finset.mem_singleton]
    constructor
  ...
  change (Option.getD (Finset.filter Nat.Prime (Finset.image (fun d => d + 1) (2 * 6).divisors)).max 0) = 13
